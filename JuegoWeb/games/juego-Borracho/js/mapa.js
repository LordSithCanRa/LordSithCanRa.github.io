        ...
        if (j % 2 === 0) {
            for (var i = 0; i < numSquares; i++) {
                ...
                if (count === 100) {
                    ...
                    context.drawImage(valdosamuro, innerSquareX, innerSquareY, innerSquareSize, innerSquareSize);
                }else if(count === 52 || count === 87){
                    context.drawImage(valdosabola, innerSquareX, innerSquareY, innerSquareSize, innerSquareSize);
                }else{
